...
const val textForChoice = "Please enter the number of the habitat you would like to view: "
const val end = "See you later!"
...
class Choice{
    fun habitat (){
        do {
            println(textForChoice)
            val yourChoice = readln()
            var youResult = ""
            when (yourChoice) {
                "0" -> youResult = animals[0]
                "1" -> youResult = animals[1]
                "2" -> youResult = animals[2]
                "3" -> youResult = animals[3]
                "4" -> youResult = animals[4]
                "5" -> youResult = animals[5]
            }
            println(youResult)
